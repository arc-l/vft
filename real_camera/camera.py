...
depth_sensor.set_option(rs.option.exposure, 2000.000)
...
tag_loc_robot = {
    22: (265.6 / 1000, -636.6 / 1000),
    7: (252.5 / 1000, -248.6 / 1000),
    4: (-275.7 / 1000, -659.7 / 1000),
    2: (-289.6 / 1000, -274.1 / 1000)
}
...
class Camera(object):
    ...
    def __init__(self):
        ...
        camera_pose = self.calibrate()
        self.configs = [{
            "image_size": (720, 1280),
            "intrinsics": self.intrinsics,
            "position": camera_pose[:3, 3],
            "rotation": R.from_matrix(camera_pose[:3, :3]).as_quat(),
            "zrange": (0.01, 1.0),
        }]
